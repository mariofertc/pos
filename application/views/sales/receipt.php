...
<div id="receipt_wrapper">
	...
	<div id="receipt_general_info">
		...
		<div id="employee"><?php echo $this->lang->line('employees_seller').": ".$employee; ?></div>
	</div>
	...
	<?php echo "<img src='http://mitoyo/SuTienda/SuTienda/index.php/barcode?barcode=$sale_id&text=$sale_id&width=250&height=50' />"; ?>
	</div>
</div>
