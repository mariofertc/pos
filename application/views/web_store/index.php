<?php $this->load->view("web_store/partial/header"); ?>
...
<?php echo form_open("sales/change_almacen",array('id'=>'almacen_form')); ?>
...
else
{
	...
	?>
		...
		<!--<td style="align:center;"><?php echo $item['name'].'-'.$item['line'].'-'.$item['item_id'].'-'.$item['item_number']; ?><br /> [<?php echo $cur_item_info->quantity.' '.$this->lang->line('sales_stock')?>]</td>-->
		<td style="align:center;"><?php echo $item['name']; ?><br /> [<?php echo $cur_item_info->quantity.' '.$this->lang->line('sales_stock')?>]</td>
...
<div id="overall_sale">
	...
	?>
		...
		?>
			<div id="finish_sale">
				<?php //echo $payments[0]['payment_id'].'i';?>
	...
	<tr>	
	<td style="width:55%; "><div class="float_left" ><?php echo $amount_due>=0 ? $this->lang->line('sales_amount_due'):$this->lang->line('sales_change_due').':'; ?></div></td>
	...
	<div id="Payment_Types" >
		...
		?>
			...
			<?php
				...
				<td>
				<?php //echo  $payment_options[$payment_id].$payment_id ?> 
				<?php echo  $payments[$payment_id]['payment_type'] ?> 
				</td>
...
<?php $this->load->view("web_store/partial/footer"); ?>
