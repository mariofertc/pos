...
function post_porpagar_form_submit(response)
{
	...
	else
	{
		...
		{
			update_row(response.receiving_id,'<?php echo site_url("$controller_name/get_row")?>');
