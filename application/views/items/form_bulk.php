...
<div class="field_row clearfix">	
<?php echo form_label($this->lang->line('items_supplier').':', 'supplier',array('class'=>'small_wide')); ?>
	<div class='form_field'>
...
<?php echo form_label($this->lang->line('items_tax_1').':', 'tax_percent_1',array('class'=>'wide')); ?>
	...
	<?php echo form_input(array(
		...
		'id'=>'tax_name_1',
		'size'=>'7',
		'value'=> isset($item_tax_info[0]['name']) ? $item_tax_info[0]['name'] : '')
	);?>
	</div>
	<div class='form_field'>
	<?php echo form_input(array(
...
<?php echo form_label($this->lang->line('items_allow_alt_desciption').':', 'allow_alt_description',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('allow_alt_description', $allow_alt_desciption_choices,"","style='width: 163px;'");?>
...
<?php echo form_label($this->lang->line('items_is_serialized').':', 'is_serialized',array('class'=>'wide')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('is_serialized', $serialization_choices,"","style='width: 163px;'");?>
