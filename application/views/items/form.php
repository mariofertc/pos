...
<?php echo form_label($this->lang->line('items_almacen').':', 'almacen',array('class'=>'required small_wide')); ?>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_supplier').':', 'supplier',array('class'=>'required small_wide')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('supplier_id', $suppliers, $selected_supplier,"style='width: 163px;'");?>
	</div>
</div>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_tax_1').':', 'tax_percent_1',array('class'=>'small_wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'tax_names[]',
		'id'=>'tax_name_1',
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_tax_2').':', 'tax_percent_2',array('class'=>'small_wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'tax_names[]',
		'id'=>'tax_name_2',
...
$(document).ready(function()
{
	...
	//Almacen Cantidad
	$("#almacen_id").change(function () {
	 $.post("<?php echo site_url('items/cantidades_almacen')?>", { item_id: "<?php echo "$item_info->item_id"?>", almacen_id: $(this).val() },
 function(data) {
 //alert(cantidad);
