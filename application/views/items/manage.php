...
<div id="search_filter_section" style="display: <?php echo isset($search_section_state)?  ( ($search_section_state)? 'block' : 'none') : 'none';?>;background-color:#EEEEEE;">
	...
	<!--Por almacenes-->
	<?php echo form_label($this->lang->line('almacenes_almacen').' '.':', 'no_description');?>
	<?php echo form_dropdown('almacen_id', $almacenes, $selected_almacen,"id = 'almacen_search' style='width: 163px;'");
