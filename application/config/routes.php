...
$route['reports/summary_:any'] = "reports/specific_summary_sale_input";
...
$route['reports/(detailed_items)/(:any)/(:any)'] = "reports/$1/$2/$3";
$route['reports/detailed_items'] = "reports/date_input_excel_export";
