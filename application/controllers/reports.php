...
//        $this->load->view("reports/specific_input", $data);
    ...
    function summary_categories($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_categories_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_customers($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_customers_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_suppliers($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_suppliers_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_items($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_items_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    **/
    function summary_employees($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_employees_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_taxes($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_taxes_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_discounts($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_discounts_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
    ...
    function summary_payments($start_date, $end_date, $almacen_id, $export_excel = 0) {
        ...
        $data = array(
            "title" => ($almacen_id != 0 ? $row['almacen'] : '') . ' ' . $this->lang->line('reports_payments_summary_report'),
            "subtitle" => date('m/d/Y', strtotime($start_date)) . '-' . date('m/d/Y', strtotime($end_date)),
            "headers" => $model->getDataColumns(),
            "data" => $tabular_data,
            "summary_data" => $model->getSummaryData(array('start_date' => $start_date, 'end_date' => $end_date, 'almacen_id' => $almacen_id)),
